...
// buildCountQuery builds a count query with the same filters as buildStoriesQuery
func (r *repo) buildCountQuery(filters stories.CoreStoryFilters) string {
