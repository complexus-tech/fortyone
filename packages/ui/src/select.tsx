...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 w-max min-w-32 overflow-hidden rounded-xl bg-surface-elevated text-foreground shadow-xl shadow-shadow backdrop-blur-md dark:bg-surface-elevated/80",
        position === "popper" &&
