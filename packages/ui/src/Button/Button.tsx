  ...
  "flex w-max items-center border gap-2 transition duration-200 ease-linear focus:outline-0",
  {
    variants: {
      ...
      color: {
        ...
        tertiary:
          "text-gray-300 dark:text-gray-200 dark:border-dark-200 dark:bg-dark-200/50 bg-gray-100 border-gray-100 focus:bg-gray-50 dark:focus:bg-dark-200 hover:bg-gray-50 active:bg-gray-50 dark:hover:bg-dark-100/50",
        secondary:
