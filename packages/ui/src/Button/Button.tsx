  ...
  "flex text-dark dark:text-gray-200 w-max items-center border gap-2 transition duration-200 ease-linear focus:outline-0",
  {
    variants: {
      ...
      color: {
        ...
        tertiary:
          "dark:border-dark-50 dark:bg-dark-100/70 bg-gray-50/80 border-gray-100 focus:bg-gray-50 dark:focus:bg-dark-200 hover:bg-gray-100/50 active:bg-gray-50 dark:hover:bg-dark-200/80",
        secondary:
