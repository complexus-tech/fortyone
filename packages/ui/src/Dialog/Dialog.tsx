...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/20 dark:bg-dark/50 flex items-start justify-center",
      className
    )}
    {...props}
  />
  ...
  <DialogPortal>
    <DialogOverlay>
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "w-full bg-white/90 mt-[10%] border border-gray-50 shadow-dark/20 dark:shadow-dark dark:border-dark-200 dark:bg-dark-300/90 backdrop-blur shadow-lg rounded-xl overflow-hidden max-w-3xl relative",
          {
            "max-w-md": size === "sm",
            "max-w-xl": size === "md",
            "max-w-5xl": size === "lg",
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex px-6 pb-[0.8rem]",
      {
        "border-t border-gray-100 dark:border-dark-200 pt-[0.8rem]":
          variant !== "bordered",
