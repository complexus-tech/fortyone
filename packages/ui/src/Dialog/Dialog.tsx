...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/30 dark:bg-black/60 flex items-start justify-center",
      className
    )}
    {...props}
  />
...
const DialogClose = ({ className }: { className?: string }) => (
  <DialogPrimitive.Close
    ...
    className={cn(
      "rounded-full p-1 inline-block hover:bg-gray-50 dark:hover:bg-dark-100 transition outline-none dark:text-gray-200",
      className
    )}
  >
