  ...
  <DialogPortal>
    <DialogOverlay>
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "w-full bg-white/90 mt-[10%] border border-gray-50 shadow-dark/20 dark:shadow-dark dark:border-dark-200 dark:bg-dark-300/60 backdrop-blur shadow-lg rounded-xl overflow-hidden max-w-3xl relative",
          {
            "max-w-md": size === "sm",
            "max-w-xl": size === "md",
            "max-w-5xl": size === "lg",
