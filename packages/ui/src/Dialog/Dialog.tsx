    ...
    <DialogPortal>
      <DialogOverlay className={overlayClassName}>
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            "relative mt-[10%] w-full max-w-3xl overflow-hidden rounded-[0.85rem] border[0.5px] border-gray-200 bg-white backdrop-blur dark:border-dark-50 dark:bg-dark-200/90",
            {
              "max-w-md": size === "sm",
              "max-w-xl": size === "md",
              "max-w-5xl": size === "lg",
