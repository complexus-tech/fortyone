...
const contentClasses = cva(
  "bg-white/70 dark:bg-dark-200/80 backdrop-blur-[12px] z-50 border border-gray-100 dark:border-dark-50 w-max shadow-lg shadow-gray-100 dark:shadow-dark/20 mt-1 py-2",
  {
    variants: {
      rounded: {
        sm: "rounded",
