...
export const OrderedListIcon = (props: Icon) => {
  ...
  return (
    ...
    >
      <path d="M11 6L21 6" stroke="currentColor" strokeLinecap="round" />
      <path d="M11 12L21 12" stroke="currentColor" strokeLinecap="round" />
      <path d="M11 18L21 18" stroke="currentColor" strokeLinecap="round" />
      <path
