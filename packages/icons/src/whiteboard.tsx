...
export const WhiteboardIcon = (props: Icon) => {
  ...
  return (
    ...
    >
      ...
      />
      <path d="M3 17H21" stroke="currentColor" strokeLinecap="round" />
      <path
      ...
      <path d="M5 22L8 17" stroke="currentColor" strokeLinecap="round" />
      <path d="M19 22L16 17" stroke="currentColor" strokeLinecap="round" />
    </svg>
  );
};
