...
category: "Planning"
featuredImage: "/images/blogs/sprint-editorial.webp"
---
...
Start with a clear sprint goal, choose work that fits the team’s capacity, and agree on what done means before the sprint begins.
...
<ProductFigure
  light="/images/product/calendar-week-light.webp"
  dark="/images/product/calendar-week-dark.webp"
  alt="FortyOne calendar week interface"
  caption="Calendar view helps the team see how planned work fits around the rest of the week."
/>
...
<WorkflowSteps title="A repeatable delivery rhythm">
  <WorkflowStep title="Plan together">
    Choose a goal and a realistic scope.
  </WorkflowStep>
  <WorkflowStep title="Work visibly">
    Keep tasks, blockers, and changes up to date.
  </WorkflowStep>
  <WorkflowStep title="Review and learn">
    Inspect the outcome and improve the next cycle.
  </WorkflowStep>
</WorkflowSteps>
...
<ArticleDetails title="Explore additional board controls">
...
<ArticleChecklist title="Put it into practice">
  <ChecklistItem>Agree on one clear sprint goal.</ChecklistItem>
  <ChecklistItem>
    Account for reviews, meetings, testing, and dependencies.
  </ChecklistItem>
  <ChecklistItem>Write acceptance criteria before work starts.</ChecklistItem>
  <ChecklistItem>
    Reserve time to review the result and the way the team worked.
  </ChecklistItem>
</ArticleChecklist>
