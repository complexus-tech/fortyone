...
export const ProductDemo = () => {
  ...
  return (
    <Container className="relative">
      ...
      >
        {/* <iframe
          className="absolute -left-[14.8%] -top-[21%] z-[3] mx-auto aspect-[16/10.25] w-screen scale-[0.605] border-0 opacity-90"
      ...
      <Blur className="absolute bottom-1/2 left-1/2 right-1/2 top-1/2 h-[900px] w-[900px] -translate-x-1/2 -translate-y-1/2 bg-primary/40 dark:bg-primary/10" />
    </Container>
  );
};
