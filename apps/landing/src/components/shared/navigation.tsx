    ...
    <Box className="fixed left-0 top-2 z-10 w-screen md:top-4">
      <Container as="nav" className="md:w-max">
        <Box className="rounded-full">
          <Box className="z-10 flex h-[3.75rem] items-center justify-between gap-6 rounded-[1.25rem] border border-gray-100/60 bg-white/80 px-2.5 backdrop-blur-lg dark:border-dark-100/50 dark:bg-dark-300/70">
