...
import createImg from "../../../../public/product/tasks/create.png";
import assignImg from "../../../../public/product/tasks/assign.png";
import automateImg from "../../../../public/product/tasks/automate.png";
import progressImg from "../../../../public/product/tasks/progress.png";
...
const Card = ({
  ...
  return (
    ...
    >
      <Box
        className={cn(
          "border-border bg-surface relative flex min-h-[400px] flex-col justify-between overflow-hidden rounded-3xl border p-6 pb-8 md:h-[420px]",
        )}
        onMouseEnter={() => {
          setIsActive(true);
        }}
        ...
        <Box>
          <Box className="relative">
            <Image
              ...
              src={src}
            />
            <Box className="via-dark/90 to-dark absolute inset-0 bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-transparent via-50%" />
          </Box>
...
export const Features = () => {
  const features = [
    {
      ...
      name: "Task Creation",
      description:
        "Create tasks with clear criteria. Organize them into sprints and objectives for better flow.",
    ...
    },
    {
      ...
      description:
        "Assign tasks to team members and track progress in real-time. Keep everyone aligned.",
  ...
  return (
    <Box className="dark from-dark-200 bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] via-black to-black pb-20 md:pb-48">
