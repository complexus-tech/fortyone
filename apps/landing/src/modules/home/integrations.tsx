...
export const Integrations = () => {
  return (
    <Box className="relative mt-20 border-b border-gray-100/80 bg-gradient-to-b from-gray-50 to-white py-16 dark:border-dark-100 dark:from-black dark:via-dark dark:to-black md:py-40">
      <Image
        alt="Slack logo"
      ...
      <Container className="relative">
        ...
        >
          ...
          >
            <Text
              className="my-10 max-w-[600px] antialiased"
              color="muted"
              fontSize="xl"
            >
