...
export const Integrations = () => {
  return (
    <Box className="relative mt-20 bg-linear-to-b from-surface-muted to-surface py-16 dark:from-background dark:via-background dark:to-black md:mb-28 md:py-40">
      <Image
        alt="Slack logo"
