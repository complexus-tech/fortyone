    ...
    <Box data-landing-reveal>
      ...
      >
        <Box className="relative -mr-5 w-[calc(100%+1.25rem)] overflow-hidden md:mr-0 md:w-auto md:overflow-visible">
          <Box className="border-border bg-background/50 dark:bg-background/5 relative rounded-l-xl rounded-r-none border p-0.5 backdrop-blur md:rounded-2xl md:p-[0.35rem]">
            <Flex
              align="center"
