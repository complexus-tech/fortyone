  ...
  return (
    <Box>
      ...
      <Container className="pt-12">
        <Box className="mt-12 mb-6 flex items-end justify-between md:mt-16">
          ...
          >
            <Text
              as="h1"
              className={cn(
                "relative z-1 text-5xl text-balance md:max-w-4xl md:text-6xl",
              )}
            >
          ...
          <motion.span
            ...
            whileInView={{ y: 0, opacity: 1 }}
          >
            <Text className="max-w-4xl opacity-80">
        ...
        <Flex align="center" className="relative gap-2 md:gap-4" wrap>
          <motion.span
            initial={{ y: -10, opacity: 0 }}
            transition={{
              duration: 1,
