...
const Tab = ({ children, value, leftIcon, rightIcon, className }: TabProps) => {
  ...
  return (
    <Pressable
      ...
      className={cn(
        "active:bg-gray-50 px-6 dark:active:bg-dark-300 py-2 rounded-[11px] flex-row justify-center gap-2 border dark:border-dark-50 border-gray-100",
        {
          "bg-gray-100/60 dark:bg-dark-100/80": isActive,
        },
        className
      )}
    >
