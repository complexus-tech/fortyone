...
description: Understand the fundamental building blocks of FortyOne.
---

## Understanding FortyOne

FortyOne is built on a few core concepts that work together to help your team manage projects and deliver work efficiently. Grasping these will unlock the full power of the platform.

### Tasks: The Unit of Work

Tasks are the backbone of your work in FortyOne. Think of them as individual tasks, bugs, features, or any piece of work that needs to be tracked from start to finish.

**Key aspects of a Task:**

- **Clear Title & Description:** What needs to be done and why.
- **Sub-Tasks:** Break down larger tasks into smaller, manageable parts.
...
Tasks flow through your customized workflows, giving everyone visibility into progress.
Learn more about [Managing Tasks](/product-guide/tasks).
...
- Link tasks to show how day-to-day work contributes to bigger goals.
...
- Can be updated manually or automatically based on linked task progress.

Key Results help you track if you're actually achieving the desired impact.

### Teams: Collaborate and Organize

Teams are groups of users in FortyOne, often reflecting your organizational structure. They are central to how work is assigned, managed, and tracked.

**With Teams, you can:**

- Organize users into functional units (e.g., `Frontend`, `API`, `Growth`).
- Assign Tasks and Objectives directly to specific teams.
...
Labels are flexible tags you can apply to Tasks (and other items) to categorize, filter, and organize your work.
...
FortyOne understands that every team has its own vocabulary. You can customize many of the terms used throughout the platform.

**For example, you can rename:**

- "Tasks" to `Issues` or `Tickets`.
- Workflow states to match your team's specific process.

This ensures FortyOne feels familiar and intuitive for everyone.
...
- **Teams** break down the work needed to achieve those KRs into **Tasks**.
- You organize and complete Tasks within **Sprints** (or Cycles).
