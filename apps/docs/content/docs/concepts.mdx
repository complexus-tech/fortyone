...
description: Understand the fundamental building blocks of Complexus.
---
...
Learn more about [Managing Stories](/docs/product-guide/stories).
...
### Sprints (or Cycles): Focused Work Periods

Sprints (you might call them Cycles) are short, time-boxed periods where your team commits to completing a set amount of work. This iterative approach helps deliver value consistently.
