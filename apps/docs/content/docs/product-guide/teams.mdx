---
title: Teams
description: Learn how to use teams to organize work, collaborate effectively, and manage projects in Forty One.
---

import { Callout } from "fumadocs-ui/components/callout";

## Understanding Teams in Forty One

Teams in Forty One are groups of workspace members. They help organize work, structure projects, and provide focused views for different groups within your organization.
...
Leveraging teams in Forty One offers several advantages:
...
- **Mentions**: You mention individual team members (`@username`) in comments on stories or objectives to draw their attention.
...
By organizing work under teams, Forty One ensures that all team members have a shared understanding of:
...
## Best Practices for Team Collaboration in Forty One
