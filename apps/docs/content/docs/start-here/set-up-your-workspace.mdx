...
The best way to learn is by doing! Let's create your first work item, typically called a "Story" in FortyOne (this term might be customized in your workspace).
