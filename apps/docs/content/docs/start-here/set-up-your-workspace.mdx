...
description: Configure your new FortyOne workspace and take your first steps towards productivity.
---

Welcome to your new FortyOne workspace! Now that your central hub is created, let's walk through a few essential first steps to get you and your team up and running smoothly.

## 1. Create Your Workspace (If You Haven't Already)

Workspace creation is the foundational step when you sign up for FortyOne. If you're just starting, ensure you've completed the sign-up process to establish your dedicated workspace.

Once your workspace is active, you can proceed with the following setup actions.

## 2. Invite Your Team Members

FortyOne shines when your team collaborates. Inviting your colleagues is a critical next step:
...
## 3. Familiarize Yourself with the FortyOne UI

Take a moment to explore the main areas of the FortyOne interface. Understanding the layout will help you navigate efficiently:

- **Sidebar (Left)**: Your primary navigation hub. Access your work (My Work, Tasks, etc.), Objectives, Sprints, Teams, and other modules.
...
- **Command Menu (via `Cmd+K` / `Ctrl+K`)**: Quickly find anything or execute commands. Search for tasks, objectives, projects, navigate to different parts of the app, or access settings.
- **User Profile & Settings (Top-Right)**: Access your personal account settings, profile, notifications, and log out.

![Placeholder overview of the FortyOne main UI areas](/command.png "FortyOne Main UI Overview")

## 4. Create Your First Team (If Applicable)

Teams in FortyOne help organize members and their work (like Sprints and Objectives) into logical groups (e.g., Engineering, Marketing, Product).
...
- **Team Code**: A short prefix for team-specific items, like Tasks (e.g., ENG, MKT).
...
The best way to learn is by doing! Let's create your first work item, typically called a "Task" in FortyOne (this term might be customized in your workspace).

- **How**: Look for a prominent **`Create Task`** button, often in the header or sidebar. Alternatively, use the universal keyboard shortcut (often `Shift+N`).
...
- Dive deeper into **[Product Guide](../product-guide/tasks)** like managing Tasks, Objectives, and Sprints.
- Understand key **[Concepts](../concepts)** that underpin FortyOne.
