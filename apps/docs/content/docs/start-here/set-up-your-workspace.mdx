...
description: Configure your new Complexus workspace and take your first steps towards productivity.
---
...
![Placeholder for where to find Invite options in UI - e.g. sidebar button or workspace menu](/placeholder.png "Inviting Team Members")
...
![Placeholder overview of the Complexus main UI areas](/placeholder.png "Complexus Main UI Overview")
...
![Placeholder showing the path to Create Team via Settings and the sidebar shortcut](/placeholder.png "Creating a New Team in Complexus")
...
- Understand key **[Concepts](../concepts)** that underpin Complexus.
- Customize your **[Workspace Settings](../administration/workspace-settings)** (Details to be added in Administration section).
