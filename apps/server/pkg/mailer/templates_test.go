...
func TestTemplatesRenderApprovedEmailSystem(t *testing.T) {
	...
	assertContains(t, rendered, `style="display: inline-block; padding: 10px 18px; border-radius: 8px; background-color: #111111; color: #ffffff; font-family: Geist, Helvetica, Arial, sans-serif; font-size: 15px; font-weight: 400; line-height: 1.35; text-align: center; text-decoration: none;"`)
