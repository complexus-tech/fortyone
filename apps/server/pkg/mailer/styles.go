...
var emailStyles = map[string]string{
	...
	"heading":             `margin: 0; max-width: 520px; color: #111111; font-family: ` + emailFontStack + `; font-size: 30px; font-weight: 600; line-height: 1.16;`,
	...
	"button":              `display: inline-block; padding: 13px 22px; border-radius: 8px; background-color: #111111; color: #ffffff; font-family: ` + emailFontStack + `; font-size: 15px; font-weight: 600; line-height: 1.35; text-align: center; text-decoration: none;`,
	...
	"notificationPanel":   `margin: 28px 0; padding: 22px 24px; border-radius: 8px; background-color: #f7f7f7; color: #303030; font-family: ` + emailFontStack + `; font-size: 15px; line-height: 1.62;`,
	"panelLabel":          `margin: 0 0 10px; color: #6f6c67; font-family: ` + emailFontStack + `; font-size: 14px; font-weight: 600; line-height: 1.4;`,
	"panelLabelTight":     `margin: 0 0 4px; color: #6f6c67; font-family: ` + emailFontStack + `; font-size: 14px; font-weight: 600; line-height: 1.4;`,
	"panelValue":          `margin: 0; color: #111111; font-family: ` + emailFontStack + `; font-size: 15px; font-weight: 500; line-height: 1.62;`,
	"panelTitle":          `margin: 0 0 12px; color: #111111; font-family: ` + emailFontStack + `; font-size: 17px; font-weight: 600; line-height: 1.3;`,
	"detailList":          `display: block; margin: 0; padding: 0; list-style: none;`,
	"detailRow":           `display: block; padding: 0 0 10px;`,
	"detailLabel":         `display: inline-block; min-width: 116px; color: #6f6c67; font-family: ` + emailFontStack + `; font-size: 14px; line-height: 1.5;`,
	"detailValue":         `color: #111111; font-family: ` + emailFontStack + `; font-size: 14px; font-weight: 500; line-height: 1.5;`,
	...
	"securityNote":        `margin: 28px 0 0; padding-top: 22px; border-top: 1px solid #e5e5e5; color: #6f6c67; font-family: ` + emailFontStack + `; font-size: 14px; line-height: 1.62;`,
	...
	"notificationText":    `margin: 0 0 12px; color: #303030; font-family: ` + emailFontStack + `; font-size: 15px; line-height: 1.62;`,
	"notificationList":    `margin: 0 0 12px; padding: 0; list-style: none;`,
	...
	"notificationLink":    `color: #111111; font-family: ` + emailFontStack + `; font-weight: 500; text-decoration: none;`,
