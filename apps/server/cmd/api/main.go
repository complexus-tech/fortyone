...
func run(ctx context.Context, log *logger.Logger) error {
	...
	muxConfig := mux.Config{
		...
		GoogleDriveClientID:         cfg.GoogleDrive.ClientID,
		GoogleDriveClientSecret:     cfg.GoogleDrive.ClientSecret,
		GoogleDriveRedirectURL:      cfg.GoogleDrive.RedirectURL,
		GoogleDrivePickerAPIKey:     cfg.GoogleDrive.PickerAPIKey,
		GoogleDriveAppID:            cfg.GoogleDrive.AppID,
