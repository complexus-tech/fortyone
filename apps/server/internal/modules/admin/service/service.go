...
type Repository interface {
	...
	ListWorkspaceIntegrations(context.Context, admindomain.ListWorkspaceIntegrationsQuery) (admindomain.ListResult[admindomain.WorkspaceIntegrationSummary], error)
	GetWorkspaceIntegrations(context.Context, admindomain.GetWorkspaceIntegrationsQuery) (admindomain.WorkspaceIntegrations, error)
	...
	ResetUserAIUsage(context.Context, admindomain.ResetUserAIUsageCommand) (admindomain.UserAIUsageReset, error)
