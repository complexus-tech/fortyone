...
func Routes(cfg Config, app *web.App) {
	...
	app.Get("/admin/integrations", h.ListWorkspaceIntegrations, auth)
	app.Get("/admin/workspaces", h.ListWorkspaces, auth)
	app.Get("/admin/workspaces/{workspaceID}", h.GetWorkspace, auth)
	app.Get("/admin/workspaces/{workspaceID}/integrations", h.GetWorkspaceIntegrations, auth)
	...
	app.Post("/admin/users/{userID}/ai-usage-reset", h.ResetUserAIUsage, auth)
