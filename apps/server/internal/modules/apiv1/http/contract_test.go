...
func TestPublicAPIOpenAPIContractIsVersionedAndSecured(t *testing.T) {
	...
	require.NotContains(t, description, "oauth", "disabled OAuth must not be advertised in the public API overview")
	require.Contains(t, description, "personal access tokens")
	require.Contains(t, description, "service-account keys")
