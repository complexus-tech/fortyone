...
type Repository interface {
	...
	GetOnboardingTourProgress(ctx context.Context, userID uuid.UUID, scope CoreOnboardingTourScope) (CoreOnboardingTourProgress, error)
	UpdateOnboardingTourProgress(ctx context.Context, userID uuid.UUID, updates CoreUpdateOnboardingTourProgress) (CoreOnboardingTourProgress, error)
