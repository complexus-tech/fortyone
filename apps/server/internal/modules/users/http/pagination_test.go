...
func TestPaginationParamsUsesMenuDefaultPageSize(t *testing.T) {
	request := httptest.NewRequest("GET", "/members?page=2", nil)
...
func TestToAppMembersResponseClearsNextPageWhenComplete(t *testing.T) {
	response := toAppMembersResponse(nil, 3, menuPageSize, false)
