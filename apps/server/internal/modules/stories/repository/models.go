...
func toCoreComment(i commentsrepository.DbComment) comments.CoreComment {
...
func toCoreComments(is []commentsrepository.DbComment) []comments.CoreComment {
...
func toDBNewComment(i stories.CoreNewComment) commentsrepository.DbNewComment {
	return commentsrepository.DbNewComment{
		StoryID:  i.StoryID,
		Parent:   i.Parent,
		UserID:   i.UserID,
		Comment:  i.Comment,
