...
func buildGitHubWebhookGateway(
	pool *pgxpool.Pool,
	...
	if pool == nil {
		return nil, nil, nil, fmt.Errorf("build GitHub webhook gateway: native database pool is required")
	}
	...
	if err != nil {
		return nil, nil, nil, fmt.Errorf("build GitHub webhook runtime: %w", err)
	}
...
var _ github.WebhookInstallationRepository = (*githubrepository.Repo)(nil)
