...
export const Sidebar = () => {
  ...
  return (
    <Box className="bg-sidebar border-border/80 dark:bg-sidebar/40 relative flex h-dvh w-(--sidebar-width) shrink-0 flex-col justify-between border-r-[0.5px] pb-6">
