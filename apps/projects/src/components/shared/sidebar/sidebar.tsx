...
export const Sidebar = () => {
  ...
  return (
    <Box className="from-sidebar to-sidebar/50 border-border/80 dark:bg-sidebar/80 relative flex h-dvh w-(--sidebar-width) shrink-0 flex-col justify-between border-r-[0.5px] bg-linear-to-br pb-6 dark:bg-none">
