  ...
  return (
    ...
    >
      <StoryContextMenu story={story}>
        <Box
          className={cn(
            "w-[340px] select-none rounded-[0.8rem] border-[0.5px] border-gray-100 bg-white px-4 pb-4 shadow-lg shadow-gray-100/50 backdrop-blur transition duration-200 ease-linear hover:bg-white/50 dark:border-dark-50 dark:bg-dark-200/60 dark:shadow-none dark:hover:bg-dark-200/90",
            {
