export const toasterIcons = {
  success: (
    <svg
      className="h-6 w-auto text-success"
      color="currentColor"
      fill="none"
      height={24}
      viewBox="0 0 24 24"
  ...
  info: (
    <svg
      className="h-6 w-auto text-dark-300 dark:text-gray-100"
      color="currentColor"
      fill="none"
      height={24}
      viewBox="0 0 24 24"
  ...
  warning: (
    <svg
      className="h-6 w-auto text-warning"
      color="currentColor"
      fill="none"
      height={24}
      viewBox="0 0 24 24"
  ...
  error: (
    <svg
      className="h-6 w-auto text-danger"
      color="currentColor"
      fill="none"
      height={24}
      viewBox="0 0 24 24"
