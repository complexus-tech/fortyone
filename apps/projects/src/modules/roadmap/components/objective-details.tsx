...
export const RoadmapObjectiveDetails = ({
  ...
  return (
    <Box className="border-border/70 dark:border-border dark:bg-surface/80 absolute top-10 right-3 bottom-6 isolate z-40 w-[calc(100%-1.5rem)] overflow-y-auto rounded-xl border bg-white/80 shadow-xl backdrop-blur-2xl md:w-[34rem]">
      <Flex
        align="center"
