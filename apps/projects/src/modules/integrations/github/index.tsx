...
export const IntegrationsIndex = () => {
  ...
  return (
    <Box>
      ...
      <Box className="border-border bg-surface rounded-2xl border">
        <SectionHeader
          description="Enhance your workspace with integrations and workflow automations."
          title="Enabled"
        />
        <Link href={withWorkspace("/settings/workspace/integrations/github")}>
          <Flex
            align="center"
            className="hover:bg-sidebar px-6 py-5 transition-colors"
            gap={3}
          >
            <GitIcon className="h-10" />
            <Box>
