export const FEEDBACK_WIDGET_LOADER_SOURCE = String.raw`(function (window, document) {
  ...
  function createWidget(rawOptions) {
    ...
    style.textContent = [
      ...
      ".root[data-theme=dark]{--widget-background:oklch(0.1821 0.0139 94);--widget-border:#292824;--widget-launcher-background:oklch(0.2135 0.0118 91.8/.96);--widget-launcher-background-hover:oklch(0.2351 0.0115 91.7/.96);--widget-launcher-border:oklch(0.94 0.014 55/.12);--widget-launcher-foreground:oklch(0.94 0.014 55);color-scheme:dark}",
