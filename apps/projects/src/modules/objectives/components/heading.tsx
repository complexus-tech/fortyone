...
export const TableHeader = ({ isInTeam }: { isInTeam?: boolean }) => {
  return (
    <Box className="sticky top-0 z-[1] hidden border-b-[0.5px] border-gray-100/60 bg-gray-50/60 py-3 backdrop-blur dark:border-dark-100 dark:bg-dark-200/90 md:block">
