export const objectiveKeys = {
  ...
  statuses: (workspaceSlug: string) =>
    [...objectiveKeys.all(workspaceSlug), "statuses"] as const,
  list: (workspaceSlug: string) =>
    [...objectiveKeys.all(workspaceSlug), "list"] as const,
  team: (workspaceSlug: string, teamId: string) =>
    [...objectiveKeys.all(workspaceSlug), "list", teamId] as const,
