...
export const CommentInput = ({
  ...
  return (
    <Flex
      className={cn(
        "ml-1 min-h-[6rem] w-full rounded-[0.6rem] border border-gray-50 bg-gray-50/40 px-4 pb-4 text-[0.95rem] shadow-sm transition-shadow duration-200 ease-linear focus-within:shadow-lg dark:border-dark-200/80 dark:bg-dark-200/50 dark:shadow-dark-300/50",
        className,
      )}
      direction="column"
      gap={2}
