...
install_env() {
  ...
  if [ "$USE_MAILPIT" = "true" ]; then
    ...
    prompt "APP_EMAIL_MAYA_FROM_NAME" "Maya from name" "Maya, AI Agent"
  ...
  prompt "APP_AUTH_MICROSOFT_CLIENT_ID" "Microsoft application (client) ID" ""
  prompt "APP_AUTH_MICROSOFT_CLIENT_SECRET" "Microsoft client secret value" ""
  prompt "APP_AUTH_MICROSOFT_TENANT" "Microsoft tenant (common supports work and personal accounts)" "common"
  prompt "APP_AUTH_MICROSOFT_REDIRECT_URL" "Microsoft OAuth redirect URL" "http://localhost:8000/auth/microsoft/callback"
  ...
  prompt "APP_AUTH_MICROSOFT_CALENDAR_REDIRECT_URL" "Outlook Calendar OAuth redirect URL" "http://localhost:8000/integrations/calendar/microsoft/callback"
  prompt "APP_AUTH_MICROSOFT_CALENDAR_WEBHOOK_URL" "Public HTTPS Outlook Calendar webhook URL (optional locally)" ""
...
APP_AUTH_MICROSOFT_CLIENT_ID=$APP_AUTH_MICROSOFT_CLIENT_ID
APP_AUTH_MICROSOFT_CLIENT_SECRET=$APP_AUTH_MICROSOFT_CLIENT_SECRET
APP_AUTH_MICROSOFT_TENANT=$APP_AUTH_MICROSOFT_TENANT
APP_AUTH_MICROSOFT_REDIRECT_URL=$APP_AUTH_MICROSOFT_REDIRECT_URL
...
APP_AUTH_MICROSOFT_CALENDAR_REDIRECT_URL=$APP_AUTH_MICROSOFT_CALENDAR_REDIRECT_URL
APP_AUTH_MICROSOFT_CALENDAR_WEBHOOK_URL=$APP_AUTH_MICROSOFT_CALENDAR_WEBHOOK_URL
...
APP_EMAIL_MAYA_FROM_NAME="$APP_EMAIL_MAYA_FROM_NAME"
